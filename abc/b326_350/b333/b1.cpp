...
int main(){
    int n,x=2,y=2,cnt=0,ans=0;
    string w="ABCDEABCD",s,t;
    cin >> s >> t;
    rep(i,5){
        if((s.at(0)==w.at(i) && s.at(1)==w.at(i+1)) || (s.at(1)==w.at(i) && s.at(0)==w.at(i+1))) x=1;
        if((t.at(0)==w.at(i) && t.at(1)==w.at(i+1)) || (t.at(1)==w.at(i) && t.at(0)==w.at(i+1))) y=1;
        if((s.at(0)==w.at(i) && s.at(1)==w.at(i+2)) || (s.at(1)==w.at(i) && s.at(0)==w.at(i+2))) x=2;
        if((t.at(0)==w.at(i) && t.at(1)==w.at(i+2)) || (t.at(1)==w.at(i) && t.at(0)==w.at(i+2))) y=2;
    }
