...
int main(){
    ...
    cin >> n;
    string s,t;
    vector<vector<bool>> c(4,vector<bool>(13,0));
    rep(i,n) {
        cin >> s;
        if(s.at(0)=='H') x=0;
        else if(s.at(0)=='D') x=1;
        else if(s.at(0)=='C') x=2;
        else if(s.at(0)=='S') x=3;
        else {cout << "No" << endl; return 0;}

        if(s.at(1)=='A') y=0;
        else if(s.at(1)=='T') y=9;
        else if(s.at(1)=='J') y=10;
        else if(s.at(1)=='Q') y=11;
        else if(s.at(1)=='K') y=12;
        else if(s.at(1)-'0'>1 && s.at(1)-'0'<10) y=s.at(1)-'0'-1;
        else {cout << "No" << endl; return 0;}

        if(c.at(x).at(y)) {cout << "No" << endl; return 0;}
        else {c.at(x).at(y)=1;}
    }
    Yes;
