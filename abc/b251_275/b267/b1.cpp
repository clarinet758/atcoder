...
int main(){
    ...
    cin >> s;
    vector<bool> w(7,1);
    if(s.at(6)=='0') w.at(0)=0;
    if(s.at(3)=='0') w.at(1)=0;
    if(s.at(1)=='0' && s.at(7)=='0') w.at(2)=0;
    if(s.at(0)=='0' && s.at(4)=='0') w.at(3)=0;
    if(s.at(2)=='0' && s.at(8)=='0') w.at(4)=0;
    if(s.at(5)=='0') w.at(5)=0;
    if(s.at(9)=='0') w.at(6)=0;

    if(s.at(0)=='0'){
        rep(i,5){
            if(w.at(i)==1 && w.at(i+1)==0){
                for(int j=i+1;j<7;j++){
                    if(w.at(j)) {print("Yes"); return 0;}
                }
            }
        }
    }
