    ...
    rep(i,2) {
        rep(j,2) {
            rep(k,2){
                ans=s.at(0)-'0';
                t=s.at(0);
                if(i%2){ans+=s.at(1)-'0'; t=t+"+"+s.at(1);}
                else {ans-=s.at(1)-'0'; t=t+"-"+s.at(1);}
                if(j%2){ans+=s.at(2)-'0'; t=t+"+"+s.at(2);}
                else {ans-=s.at(2)-'0'; t=t+"-"+s.at(2);}
                if(k%2){ans+=s.at(3)-'0'; t=t+"+"+s.at(3);}
                else {ans-=s.at(3)-'0'; t=t+"-"+s.at(3);}

                if(ans==7) {cout << t << "=7" << endl; return 0;}
            }
        }
    }
    return 0;
