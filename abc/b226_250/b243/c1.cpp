...
int main(){
    ...
    rep(i,s.size()){
        if(s.at(i)=='L' && p[a.at(i).second]==0){
            w[a.at(i).second]={mod,a.at(i).first};
            p[a.at(i).second]=1;
        }else if(s.at(i)=='L'){
            w[a.at(i).second].second=max(w[a.at(i).second].second,a.at(i).first);
        }else if(s.at(i)=='R' && p[a.at(i).second]==0){
            w[a.at(i).second]={a.at(i).first,-1};
            p[a.at(i).second]=1;
        }else{
            w[a.at(i).second].first=min(w[a.at(i).second].first,a.at(i).first);
        }
        if(w[a.at(i).second].first<w[a.at(i).second].second) ans=1;
    }
