...
int main(){
    ...
    rep(i,s.size()) {
        if (s.at(i)=='N') w.at(0)++;
        else if (s.at(i)=='W') w.at(1)++;
        else if (s.at(i)=='S') w.at(2)++;
        else if (s.at(i)=='E') w.at(3)++;
    }
    cout << ((((w.at(0)==0 && w.at(2)==0)||(w.at(0)>0 && w.at(2)>0)) && ((w.at(1)==0 && w.at(3)==0)||(w.at(1)>0 && w.at(3)>0)))?"Yes":"No") << endl;
    return 0;
}
