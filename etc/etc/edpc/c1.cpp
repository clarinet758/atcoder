...
int main(){
    ...
    rep(i,n) {
        cin >> x >> y >> z;
        if(i){
            a.at(i).at(0)=max(a.at(i-1).at(1)+x,a.at(i-1).at(2)+x);
            a.at(i).at(1)=max(a.at(i-1).at(0)+y,a.at(i-1).at(2)+y);
            a.at(i).at(2)=max(a.at(i-1).at(0)+z,a.at(i-1).at(1)+z);
        }else{
            a.at(0).at(0)=x;
            a.at(0).at(1)=y;
            a.at(0).at(2)=z;
    ...
    cout << max({a.at(n-1).at(0),a.at(n-1).at(1),a.at(n-1).at(2)}) << endl;
    return 0;
}